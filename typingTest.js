...
var calculateScore = function() {
    var paraSumbitted = textArea.value;
    var sumbittedWords = paraSumbitted.split(" ");
    var wordCount = sumbittedWords.length;
...
var displayTime = function() {
    var getTime = setInterval(function() {
        remainingTime--;
        timer.innerHTML = "Time Remaining: " + remainingTime + "s";
